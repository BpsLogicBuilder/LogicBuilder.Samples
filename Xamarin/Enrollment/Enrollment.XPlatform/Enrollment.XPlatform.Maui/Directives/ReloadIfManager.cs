...
namespace Enrollment.XPlatform.Directives
{
    ...
    {
        public ReloadIfManager(IMapper mapper, IUiNotificationService uiNotificationService, IEnumerable<IFormField> currentProperties, List<ReloadIf<TModel>> conditions)
        {
