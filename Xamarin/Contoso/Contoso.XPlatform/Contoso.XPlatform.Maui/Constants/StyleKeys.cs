namespace Contoso.XPlatform.Constants
{
    internal struct StyleKeys
    {
        ...
        public const string PopupHeaderLabelStyle = nameof(PopupHeaderLabelStyle);
        public const string PopupHeaderStyle = nameof(PopupHeaderStyle);
        ...
        public const string TextFormGroupHeaderStyle = nameof(TextFormGroupHeaderStyle);
        public const string TextFormHyperLinkLabelStyle = nameof(TextFormHyperLinkLabelStyle);
