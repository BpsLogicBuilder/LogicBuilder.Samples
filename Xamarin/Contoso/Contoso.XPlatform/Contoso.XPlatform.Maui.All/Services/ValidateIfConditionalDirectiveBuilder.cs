    ...
    public class ValidateIfConditionalDirectiveBuilder<TModel> : IConditionalDirectiveBuilder<ValidateIf<TModel>, TModel>
    {
        ...
        public List<ValidateIf<TModel>> GetConditions()
        {
            ...
            List<ValidateIf<TModel>> conditions = formGroupSettings.ConditionalDirectives?.Aggregate(parentList ?? new List<ValidateIf<TModel>>(), (list, kvp) =>
            {
                ...
                (
                    descriptor =>
                    {
                        ...
                        HashSet<string> validationsToWatch = new((IEnumerable<string>)validationsToWatchDescriptor.Value);
            ...
            void AddConditions(FormItemSettingsDescriptor descriptor)
            {
                ...
                conditions = this.directiveManagersFactory.GetDirectiveConditionsBuilder<ValidateIf<TModel>, TModel>
                (
                    childForm,
                    properties,
                    conditions,
