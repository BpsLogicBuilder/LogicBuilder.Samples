...
namespace Contoso.Bsl.Flow.Integration.Tests.Rules
{
    public class RulesVsNoRulesDurationTest
    {
        ...
        public async Task SaveStudentRequestWithEnrollments1()
        {
            ...
            var student = (await flowManager.SchoolRepository.GetAsync<StudentModel, Student>(s => s.FullName == "Carson Alexander", selectExpandDefinition: new LogicBuilder.Expressions.Utils.Expansions.SelectExpandDefinition(null,  [new LogicBuilder.Expressions.Utils.Expansions.SelectExpandItem("enrollments")]))).Single();
        ...
        public async Task SaveStudentRequestWithEnrollmentsWithoutRules1()
        {
            ...
            studentModel = (await schoolRepository.GetAsync<StudentModel, Student>(f => f.ID == studentModel.ID, null, new LogicBuilder.Expressions.Utils.Expansions.SelectExpandDefinition(null, [new LogicBuilder.Expressions.Utils.Expansions.SelectExpandItem("enrollments")]))).SingleOrDefault();
