...
namespace Contoso.Utils
{
    internal static class AnonymousTypeFactory
    {
        ...
        {
            AssemblyName dynamicAssemblyName = new AssemblyName("Contoso.Utils.TempAssembly");
            AssemblyBuilder dynamicAssembly = AssemblyBuilder.DefineDynamicAssembly(dynamicAssemblyName, AssemblyBuilderAccess.Run);
            ModuleBuilder dynamicModule = dynamicAssembly.DefineDynamicModule("Contoso.Utils.TempAssembly");
