...
namespace Enrollment.AutoMapperProfiles
{
    public class InputVariablesMappingProfile : Profile
    {
        public InputVariablesMappingProfile()
        {
            ...
            CreateMap<InputView<IEnumerable<StateLivedInModel>>, InputQuestionParameters<IEnumerable<StateLivedInModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<IEnumerable<StateLivedInModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<IEnumerable<StateLivedInModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<IEnumerable<StateLivedInModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<InputView<ICollection<StateLivedInModel>>, InputQuestionParameters<ICollection<StateLivedInModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<ICollection<StateLivedInModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<ICollection<StateLivedInModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<ICollection<StateLivedInModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
			...
			CreateMap<InputView<IList<StateLivedInModel>>, InputQuestionParameters<IList<StateLivedInModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<IList<StateLivedInModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<IList<StateLivedInModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<IList<StateLivedInModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<InputView<StateLivedInModel>, InputQuestionParameters<StateLivedInModel>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<StateLivedInModel>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<StateLivedInModel>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<StateLivedInModel>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<BaseInputView, BaseInputQuestionParameters>()
				...
				.Include<InputView<StateLivedInModel>, InputQuestionParameters<StateLivedInModel>>()
				.Include<InputView<IEnumerable<StateLivedInModel>>, InputQuestionParameters<IEnumerable<StateLivedInModel>>>()
				.Include<InputView<ICollection<StateLivedInModel>>, InputQuestionParameters<ICollection<StateLivedInModel>>>()
				.Include<InputView<IList<StateLivedInModel>>, InputQuestionParameters<IList<StateLivedInModel>>>()
            .ReverseMap()
				...
				.Include<InputQuestionParameters<StateLivedInModel>, InputView<StateLivedInModel>>()
				.Include<InputQuestionParameters<IEnumerable<StateLivedInModel>>, InputView<IEnumerable<StateLivedInModel>>>()
				.Include<InputQuestionParameters<ICollection<StateLivedInModel>>, InputView<ICollection<StateLivedInModel>>>()
				.Include<InputQuestionParameters<IList<StateLivedInModel>>, InputView<IList<StateLivedInModel>>>();
        }
    }
}