...
namespace Contoso.Forms.View.Validators
{
    public static class ValidationManager
    {
        ...
        public static List<string> DoValidation(object inputValue, string variableName, FormValidationSettingView validationSetting, Dictionary<string, string> messages)
        {
            ...
            object[] GetArguments(ValidatorDescriptionView validator)
            {
