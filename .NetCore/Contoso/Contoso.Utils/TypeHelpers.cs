...
namespace Contoso.Utils
{
    public static class TypeHelpers
    {
        ...
        ///// <summary>
        ///// Deep Clone an object ginen JsonSerializerSettings
        ///// </summary>
        ///// <typeparam name="T"></typeparam>
        ///// <param name="source"></param>
        ...
        //public static bool HasDefaultContrucor(this Type type)
        //{
        //    return type.GetConstructors(BindingFlags.Public | BindingFlags.Instance).SingleOrDefault(c => c.GetParameters().Count() == 0) != null;
        //}
