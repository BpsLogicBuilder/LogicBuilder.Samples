                            ...
                            new List<InputColumnParameters>
                            {
                                ...
                                (
                                    ...
                                    new List<BaseInputQuestionParameters>
                                    {
                                        ...
                                        new InputQuestionParameters<ICollection<Contoso.Domain.Entities.InstructorModel>>(5, "FifthVariable", new System.Collections.ObjectModel.Collection<Contoso.Domain.Entities.InstructorModel> { new Contoso.Domain.Entities.InstructorModel {  FirstName = "Sam" } }, new InputDataParameters
                                        (
                                            "Is person at home?",
                                            "col-md-12",
                                            "ChackBox",
                            ...
                            new InputColumnView
                            {
                                ...
                                Questions = new List<BaseInputView>
                                {
                                    new InputView<bool>
                                    {
                                        ...
                                        ClassAttribute = "col-md-2",
                                        CurrentValue = true,
                                        Directives = new List<Contoso.Forms.View.Common.DirectiveView>
                                        {
                                            new Contoso.Forms.View.Common.DirectiveView
                                            {
                                                ConditionGroup = new Contoso.Forms.View.Common.ConditionGroupView
                                                {
                                                    Conditions = new List<Contoso.Forms.View.Common.ConditionView>
                                                    {
                                                        new Contoso.Forms.View.Common.ConditionView
                                                        {
                                                            LeftVariable = "NNN",
                                                                Operator= "eqyals",
                                                                Value = "VVV"
