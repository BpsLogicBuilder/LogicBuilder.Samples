...
namespace Contoso.AutoMapperProfiles
{
    public class InputVariablesMappingProfile : Profile
    {
        public InputVariablesMappingProfile()
        {
            ...
            CreateMap<InputView<IEnumerable<InstructorModel>>, InputQuestionParameters<IEnumerable<InstructorModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<IEnumerable<InstructorModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<IEnumerable<InstructorModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<IEnumerable<InstructorModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<InputView<ICollection<InstructorModel>>, InputQuestionParameters<ICollection<InstructorModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<ICollection<InstructorModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<ICollection<InstructorModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<ICollection<InstructorModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
			...
			CreateMap<InputView<IList<InstructorModel>>, InputQuestionParameters<IList<InstructorModel>>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<IList<InstructorModel>>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<IList<InstructorModel>>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<IList<InstructorModel>>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<InputView<InstructorModel>, InputQuestionParameters<InstructorModel>>()
                .ConstructUsing((source, context) => new InputQuestionParameters<InstructorModel>
                {
                    QuestionData = context.Mapper.Map<InputDataParameters>(source)
                })
                .ReverseMap()
                .ConstructUsing((source, context) =>
                {
                    return context.Mapper.Map<InputView<InstructorModel>>((InputDataParameters)source.QuestionData);
                });
            CreateMap<InputDataParameters, InputView<InstructorModel>>()
				.ForMember(dest => dest.CurrentValue, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.VariableName, opt => opt.Ignore())
				.ForMember(dest => dest.Errors, opt => opt.Ignore())
            ...
            CreateMap<BaseInputView, BaseInputQuestionParameters>()
				...
				.Include<InputView<InstructorModel>, InputQuestionParameters<InstructorModel>>()
				.Include<InputView<IEnumerable<InstructorModel>>, InputQuestionParameters<IEnumerable<InstructorModel>>>()
				.Include<InputView<ICollection<InstructorModel>>, InputQuestionParameters<ICollection<InstructorModel>>>()
				.Include<InputView<IList<InstructorModel>>, InputQuestionParameters<IList<InstructorModel>>>()
            .ReverseMap()
				...
				.Include<InputQuestionParameters<InstructorModel>, InputView<InstructorModel>>()
				.Include<InputQuestionParameters<IEnumerable<InstructorModel>>, InputView<IEnumerable<InstructorModel>>>()
				.Include<InputQuestionParameters<ICollection<InstructorModel>>, InputView<ICollection<InstructorModel>>>()
				.Include<InputQuestionParameters<IList<InstructorModel>>, InputView<IList<InstructorModel>>>();
        }
    }
}