...
namespace Contoso.KendoGrid.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Contoso.KendoGrid.Api", Version = "v1" });
            });
            ...
            if (app.Environment.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Contoso.KendoGrid.Api v1"));
            }
