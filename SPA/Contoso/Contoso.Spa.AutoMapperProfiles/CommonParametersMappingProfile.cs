...
namespace Contoso.Spa.AutoMapperProfiles
{
    public class CommonParametersMappingProfile : Profile
    {
        public CommonParametersMappingProfile()
        {
            CreateMap<ListFormSettingsParameters, ListFormSettingsView>().ReverseMap();
            ...
            CreateMap<FormRequestDetailsParameters, FormRequestDetailsView>().ReverseMap();
            CreateMap<FormValidationSettingParameters, FormValidationSettingView>().ReverseMap();
            CreateMap<GridRequestDetailsParameters, GridRequestDetailsView>().ReverseMap();
