...
namespace Enrollment.Utils
{
    internal static class AnonymousTypeFactory
    {
        ...
        {
            AssemblyName dynamicAssemblyName = new AssemblyName("Enrollment.Utils.TempAssembly");
            AssemblyBuilder dynamicAssembly = AssemblyBuilder.DefineDynamicAssembly(dynamicAssemblyName, AssemblyBuilderAccess.Run);
            ModuleBuilder dynamicModule = dynamicAssembly.DefineDynamicModule("Enrollment.Utils.TempAssembly");
